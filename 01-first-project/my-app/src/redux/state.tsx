...
let state: IAppState = {
    ...
    messagePage: {
        dialogsData: [
            ...
            { id: 3, name: "Mother", avatar: "https://cdn.dribbble.com/users/1162650/screenshots/15637865/media/df7d2c7a8570d2db9d07ea46f68057d5.jpg?compress=1&resize=800x600" },
        ],
        messagesData: [
            { id: 1, message: "Hi" },
            { id: 2, message: "Yo" },
